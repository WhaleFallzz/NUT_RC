...
export DATA_DIR=/home/rthuang/Experimental_result_TweetQA/Norm_SPLT/gqa_data_unilm/train
export OUTPUT_DIR=/home/rthuang/Experimental_result_TweetQA/Norm_SPLT/debug_gen_RC_1110
export MODEL_RECOVER_PATH=/home/rthuang/script/pre-bert-model/bert-large-uncased-whole-word-masking/pytorch_model.bin
# export MODEL_RECOVER_PATH=/home/rthuang/script/pre-trained-unilm-models/unilmv1-large-cased.bin
export CUDA_VISIBLE_DEVICES=0

python generative_RC.py \
  --do_train \
